...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    public class ClrPropertySetterFactoryTest
    {
        ...
        public void Delegate_setter_can_set_index_properties()
        {
            ...
            var propertyA = entityType.AddProperty("PropertyA", typeof(string), IndexedClass.IndexerProperty);
            var propertyB = entityType.AddProperty("PropertyB", typeof(int), IndexedClass.IndexerProperty);
