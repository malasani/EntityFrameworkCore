...
namespace Microsoft.EntityFrameworkCore.Metadata.Internal
{
    public class ClrPropertyGetterFactoryTest
    {
        ...
        public void Delegate_getter_is_returned_for_index_property()
        {
            ...
            var propertyA = modelBuilder.Entity<IndexedClass>().Metadata
                .AddProperty("PropertyA", typeof(string), IndexedClass.IndexerProperty);
            var propertyB = modelBuilder.Entity<IndexedClass>().Metadata
                .AddProperty("PropertyB", typeof(int), IndexedClass.IndexerProperty);
            modelBuilder.FinalizeModel();
        ...
        {
            public static readonly PropertyInfo IndexerProperty = typeof(IndexedClass)
                .GetRuntimeProperties().FirstOrDefault(pi => pi.IsIndexerProperty());
